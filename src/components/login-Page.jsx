...
export default function LoginPage() {
  ...
  const handleGmailSubmit = (e) => {
    ...
    console.log("Gmail login:", gmailUsername, "password:", gmailPassword);
    // Reset form
    setGmailUsername("");
    setGmailPassword("");
  };
          ...
          {!showGmailLogin ? (
            <form onSubmit={submitThis}>
              <div className="flex flex-col">
                <label
                  htmlFor="username"
                  className="mx-5 md:mx-10 lg:mx-16 my-2"
                >
                  Username
                </label>
                <input
            ...
            <form onSubmit={handleGmailSubmit}>
              <div className="flex flex-col">
                ...
                <input
                  ...
                  className="mx-5 md:mx-10 lg:mx-16 py-2 px-1 rounded-sm mb-3"
                />
                <label
